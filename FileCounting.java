 ...
 * Google Gemini -> 'how to get the time of compiling a thread from start to end in java'
 * ChatGPT -> 'how to count the files in a direcroty and subdirectory in java with multiple threads'
 * ChatGPT -> 'how to use ThreadPool to count files in a directory and subdirectory in java'
 * ChatGPT -> 'how to make the Thread of ThreadPool to wait until all threads are done in java'
 * 
 */
